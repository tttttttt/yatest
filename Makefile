# This Makefile is for the Memcached::Client2 extension to perl.
#
...
#     AUTHOR => [q[Marat Kanzafarov, marat.kanzafarov@gmail.com]]
#     BUILD_REQUIRES => { Test::More=>q[0] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Memcached-Client2]
#     EXE_FILES => []
#     NAME => q[Memcached::Client2]
#     PREREQ_PM => { Test::More=>q[0], Data::Dumper=>q[0], IO::Socket::INET=>q[0], Exporter=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Memcached/Client2.pm]
#     test => { TESTS=>q[t/*.t] }
...
MAKE = make
FULLEXT = Memcached/Client2
BASEEXT = Client2
PARENT_NAME = Memcached
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Memcached
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Memcached
...
TO_INST_PM = cli.pl \
	lib/Memcached/Client2.pm

PM_TO_BLIB = cli.pl \
	$(INST_LIB)/Memcached/cli.pl \
	lib/Memcached/Client2.pm \
	blib/lib/Memcached/Client2.pm
...
DISTVNAME = Memcached-Client2-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Marat Kanzafarov, marat.kanzafarov@gmail.com'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Memcached-Client2' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Marat Kanzafarov, marat.kanzafarov@gmail.com"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Memcached-Client2",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Marat Kanzafarov, marat.kanzafarov@gmail.com</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  cli.pl $(INST_LIB)/Memcached/cli.pl \
	  lib/Memcached/Client2.pm blib/lib/Memcached/Client2.pm 
